...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.sendForm('service_wk2km1l', 'template_7erxvkm', formRef.current, 'QOoxduuqXSlP_FADi')
      .then((result) => {
      ...
      <div className="container contact__container">
        <div className="contact__options">
          <article className="contact__option">
            ...
            <h4>Email</h4>
            <h5>umar.draz2519@gmail.com</h5>
            <a href="mailto:umar.draz2519@gmail.com">Send a message</a>
          </article>
        </div>
